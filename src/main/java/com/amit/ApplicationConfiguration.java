...
import com.amit.websocket.MyHandler;
...
@EnableCouchbaseRepositories(basePackages = "com.amit.couch.repositories")
...
public class ApplicationConfiguration extends MetricsConfigurerAdapter implements WebSocketConfigurer
{
...
//
    ...
    //note : for fallback , in case broweser does not support websocket implement sockjs
    @Override
    public void registerWebSocketHandlers(WebSocketHandlerRegistry webSocketHandlerRegistry) {
        webSocketHandlerRegistry.addHandler(new MyHandler(),"/websocket/test").addInterceptors(new HttpSessionHandshakeInterceptor());
    }


    //Note : only for tomcat , Wildfly and Glassfish
    @Bean
